...
public class FrequentWords {
	...
	public static void main(String[] args) throws Exception {
		...
		// FileOutputFormat.setOutputPath(counterJob, outputPath);
		// outputPath.getFileSystem(counterConf).delete(outputPath, true);
		...
		// job 2 - vertauscht key und value im mapper
		...
		sorterJob.setReducerClass(Reducer.class);
		...
		Job outputJob = Job.getInstance(outputConf, "partitioner");
